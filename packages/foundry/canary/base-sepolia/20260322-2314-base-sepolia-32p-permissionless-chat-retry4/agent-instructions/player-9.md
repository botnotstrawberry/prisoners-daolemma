...
- Wallet: 0xBD592997601d44dfC40B7fD3B7FA5b506392B6A7
- Cause: 1 — Protocol Guild
- Cluster: catch
...
- Round 1 planned choice: catch
  - You believe the table is leaning too hard into Steal, so Catch is your best response.
- Round 2 planned choice if still alive: catch
  - You believe the surviving field will overcorrect after the first elimination and expose itself to Catch.
