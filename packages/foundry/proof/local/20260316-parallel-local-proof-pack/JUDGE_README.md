...
### Local proof
- This compact local proof pack preserves 1 copied matrix artifact set(s) rooted in validated current local runs.
...
- This pack stays compact on purpose: Raw tx logs, per-run report.json files, and per-game exports from the source matrix directory are intentionally omitted here to keep the checked-in bundle compact.
...
- Generated at: 2026-03-16T03:58:53.501Z
...
- Not preserved here: Raw tx logs, per-run report.json files, and per-game exports from the source matrix directory are intentionally omitted here to keep the checked-in bundle compact.
- Not preserved here: The copied matrix-report.json file is preserved as captured, including path references back to the original source directory on the capture machine.
