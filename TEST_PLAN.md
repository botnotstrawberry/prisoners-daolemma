...
- heavier multi-instance parallel saturation beyond the current bounded 6-instance host-local proof
...
- the lower bound of that 6-10 deployment saturation envelope is now proven locally at 6 overlapping instances, but heavier 7-10 deployment saturation is still unproven
...
- the heavier 7-10 deployment Mode C saturation envelope beyond the current checked-in 6-instance host-local proof
