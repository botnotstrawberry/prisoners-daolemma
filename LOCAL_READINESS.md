...
- Host-local parallel coverage is now real but still bounded: the checked-in proof reaches 6 overlapping isolated harness + Anvil instances on one machine, but heavier 7-10 deployment saturation beyond that lower bound remains unproven locally.
